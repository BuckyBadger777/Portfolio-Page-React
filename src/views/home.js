    ...
    <div className="home-container">
      ...
      <div data-role="Header" className="home-navbar-container">
        <div className="home-navbar">
          <span className="home-heading">The Cieslewski&apos;s</span>
      ...
      <div className="home-container02">
        <div className="home-hero">
          <div className="home-hero-text-container">
            ...
            <span className="home-text Section-Text">June 7 2025</span>
            <div className="home-cta-btn-container">
              ...
              <button className="home-cta-btn1 button">
                <span>
                  <span className="Anchor home-text07">RSVP</span>
                  <br></br>
                  <span className="home-text09">Here</span>
                  <br></br>
                </span>
              </button>
            </div>
      ...
      <div className="home-features">
        <div className="home-heading-container">
          ...
          <span className="home-text14 Section-Text">Where are the buses?</span>
        </div>
      ...
      <div className="home-clients">
        <div className="home-heading-container1">
          <h1 className="home-text18 Section-Heading">Our Families</h1>
      ...
      <div className="home-pricing">
        <div className="home-heading-container2">
          <h1 className="home-text20">Registries</h1>
        ...
        <div className="home-pricing-card-container">
          <div className="home-card3">
            <div className="home-card-heading">
              ...
              <span className="Section-Heading">Prada</span>
            </div>
          ...
          <div className="home-card4">
            <div className="home-card-heading1">
              ...
              <span className="Section-Heading">Gucci</span>
            </div>
          ...
          <div className="home-card5">
            <div className="home-card-heading2">
              ...
              <span className="Section-Heading">Dolce</span>
            </div>
      ...
      <div className="home-subscribe">
        ...
        <div className="home-container11">
          ...
          />
          <button className="home-button2 Anchor button">SEND</button>
        </div>
      </div>
